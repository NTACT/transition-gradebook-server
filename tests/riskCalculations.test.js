...
describe('Risk Calculations', () => {
  ...
  rapidTest('calculateRiskLevelsForKey gpa should return medium the gpa is in range 2.5-2.99 for any grade', rapid => {
  ...
  rapidTest('calculateRiskLevelsForKey gpa should return high the gpa is in range 2-2.49 for any grade', rapid => {
  ...
  rapidTest('calculateRiskLevelsForKey gpa should return ultra the gpa is in range 0-2 for any grade', rapid => {
