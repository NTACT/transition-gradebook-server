  ...
  if (multipleBars) {
    return data.labels.map((entry, index) => {
      ...
      return React.createElement(Bar, {
        ...
        stroke: color,
        fill: "white",
        shape: index % 2 === 0 ? React.createElement(DiagonalStripes, {
          stroke: color
        }) : null
    ...
    return riskIndicatorArray.map((entry, index) => React.createElement(Bar, {
      key: entry.key,
      barSize: barSize,
      dataKey: entry.key,
      shape: React.createElement(DiagonalStripes, {
        stroke: entry.color
      })
    }, React.createElement(LabelList, {
      position: "top",
...
const generateCaptions = (data, {
  ...
  if (multipleBars) {
    return React.createElement("div", {
      ...
      return React.createElement("div", {
        key: entry.key,
        className: "vertical-bar-chart-caption-item"
      }, React.createElement("div", {
        className: "vertical-bar-chart-caption-color",
        style: {
    ...
    return React.createElement("div", {
      ...
      className: "vertical-bar-chart-caption-content"
    }, riskIndicatorArray.map((entry, index) => React.createElement("div", {
      key: index,
      className: "vertical-bar-chart-caption-item vertical-bar-chart-caption-risk"
    }, React.createElement("div", {
...
module.exports = ({
  ...
  return React.createElement("div", {
  ...
  }, title), React.createElement("div", null, React.createElement(BarChart, {
    width: 700,
    height: 400,
    data: multipleBars ? data.values : data
    ...
    domain: [0, dataMax => Math.floor(dataMax * 1.1) + 1]
    /* Keep labels from being cut off by the top of the chart */
    ...
    riskChart,
    barColors
  }), React.createElement("style", null, verticalBarChartStyle));
};