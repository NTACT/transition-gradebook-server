...
const ActivityHeader = ({
  ...
  }, total), title), React.createElement("div", {
...
const ActivityRow = ({
  ...
  return React.createElement("div", {
    ...
    className: "activities-table-value activities-table-events"
  }, React.createElement("div", null, events)), React.createElement("div", {
    className: "activities-table-value activities-table-frequency"
  }, React.createElement("div", null, frequency)), React.createElement("div", {
    className: "activities-table-notes"
  }, React.createElement("div", null, truncate(notes, {
    length: 80,
    omission: '...'
  }))));
};
...
module.exports = ({
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    total: total,
    title: title,
    header: activitiesHeaders
  }), data.map((entry, i) => React.createElement(ActivityRow, {
    key: i,
    entry: entry
  }))), React.createElement("style", null, activitiesTableStyle));
};