...
class RiskRosterReport extends Component {
  render() {
    ...
    }), React.createElement(RiskRosterTable, {
      data: firstChunk,
      maxCount: 10
    }), remainingChunks.map((studentGroup, index) => React.createElement(RiskRosterTable, {
      key: index,
      data: studentGroup,
      maxCount: 12
    })));
...
module.exports = data => React.createElement(RiskRosterReport, {
  data: data
});