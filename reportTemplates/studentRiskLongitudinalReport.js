...
let StudentRiskLongitudinalReport = class StudentRiskLongitudinalReport extends Component {
  render() {
    const {
      schoolSettings,
      students,
    ...
    return React.createElement(
      ...
      students.map((student, i) => {
        ...
        return React.createElement(
          ...
          React.createElement(TermsTable, { title: 'Risk Factors', data: riskFactors, rowHeight: 23 }),
          React.createElement(TermsTable, { title: 'Areas where student might need support or intervention', data: studentNeeds, rowHeight: 20, useIcons: true })
        );
      }),
      React.createElement(
        'style',
        null,
        studentRiskReportStyle
      )
    );
  }
};
...
module.exports = data => React.createElement(StudentRiskLongitudinalReport, { data: data });