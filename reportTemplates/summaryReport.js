...
class SummaryReport extends Component {
  render() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(SingleTermReportTitle, {
    ...
    }), React.createElement(GradeAndAgeTable, {
      data: gradeAndAgeRepartition
    }), React.createElement(DisabilityTable, {
      data: disabilityRepartition
    }), React.createElement(RiskTable, {
      data: riskRepartition
    }), React.createElement(ChartContainer, null, React.createElement(HorizontalBarChart, {
      title: "Role in IEP Meeting",
      ...
      data: careerAwarenessActivities
    }), React.createElement(ActivityGroupTable, {
      title: "Work Experience Activities",
      data: workExperienceActivities
    }), React.createElement(ActivityGroupTable, {
      title: "Inclusion Activities",
      data: inclusionActivities,
      style: {
        marginBottom: 50
      }
    }), React.createElement(ActivityGroupTable, {
      title: "Student Supports Activities",
      data: studentSupportsActivities
    }), React.createElement(ActivityGroupTable, {
...
module.exports = data => React.createElement(SummaryReport, {
  data: data
});