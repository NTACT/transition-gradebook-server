      ...
      React.createElement(
        ...
        React.createElement(
          ...
          criteria2Labels.map(({ key, label }, i) => {
            const total = criteria1Labels.reduce((total, { key: criteria1Key }) => total + studentGroups[criteria1Key][key], 0);
            return React.createElement(
              React.Fragment,
              { key: key },
              React.createElement(
                ...
                React.createElement(
                  CrossTableCell,
                  null,
                  React.createElement(StripeBar, { index: i }),
                  React.createElement(
                    RowTitle,
                    null,
                    label
                ...
                criteria1Labels.map(({ key: criteria1Key }) => React.createElement(
                  CrossTableCell,
                  { key: criteria1Key },
...
function CrossTable(props) {
  return React.createElement('table', _extends({}, props, { className: 'cross-table' }));
}

function CrossTableHeader(props) {
  return React.createElement('thead', _extends({}, props, { className: 'cross-table-header' }));
}

function CrossTableContent(props) {
  return React.createElement('tbody', _extends({}, props, { className: 'cross-table-content' }));
}

function CrossTableFooter(props) {
  return React.createElement('tfoot', _extends({}, props, { className: 'cross-table-footer' }));
}

function CrossTableCell(props) {
  return React.createElement('td', _extends({}, props, { className: 'cross-table-cell' }));
}

function CrossTableTotalCell(props) {
  return React.createElement('td', _extends({}, props, { className: 'cross-table-total-cell' }));
}
